...
| `testcenter.json`               | Mock-exam test-centre index: 377 self-marking papers, the Cambridge 4-21 holdings matrix, 1,099 hand-tagged question groups and the platform's production score calibration.                                                                   |
| `wordbanks.json`                | Word-bank concordance of a deployed vocabulary-learning system: seven banks (47,044 rows / 15,930 words), the pairwise overlap matrix, the Cambridge coverage join, collocation aggregates, the review-engine parameters and the prompt banks. |
