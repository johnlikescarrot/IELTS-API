...
| `samples.json`                  | Metadata index of 45 files in a 557-file classroom collection: 24 authentic learner essays dated by session, and 12 Academic Reading sample tasks linked to the question-type taxonomy. |
