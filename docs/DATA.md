...
| `blueprints.json`               | Cambridge test blueprints: 1,099 question groups from volumes 5-21 (136 papers) annotated by canonical task family, subject scene and difficulty, with per-paper annotation completeness.                 |
