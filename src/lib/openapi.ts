  ...
  return {
    ...
    info: {
      ...
      description: [
        ...
        '',
        'Datasets: Cambridge IELTS 1-22 vocabulary (4,174 headwords), 44 vocabulary',
        'collections (22 Cambridge volumes + 22 thematic scenes), difficulty estimates',
        'and review queues, analytic band descriptors, score concordances, Writing and',
        'Speaking task banks, a canonical question-type taxonomy with observed',
        'frequencies, response frameworks for the productive papers, a structure and',
        'readability index of 1,702 practice tests, an index of the open IELTS research',
        'corpus, an index of a 2,385-file self-study materials collection, and a',
        'mock-exam test-centre index with the Cambridge 4-21 holdings, 1,099',
        'hand-tagged question groups and a production raw-score-to-band calibration.',
        'The toolkit additionally scores any text (readability and essay profile),',
        'simulates spaced repetition (Ebbinghaus, Leitner, SM-2), plans streaks and',
        'heat-maps, and composes the datasets into study plans.',
        '',
