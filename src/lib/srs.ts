 ...
 * - **SM-2** — the Wozniak (1990) algorithm used by Anki. Each card carries
 ...
 * All functions are deterministic and dependency-free so the results are
 * reproducible on every replica and citable by seed + parameters.
 *
 * References:
 * - Ebbinghaus, H. (1885). *Über das Gedächtnis.*
 * - Leitner, S. (1972). *So lernt man lernen.*
 * - Wozniak, P. A. (1990). Optimization of learning. Unpublished MSc.
 * - Cepeda, N. J. et al. (2008). Spacing effects in learning. *Rev. Gen. Psychol.*
 */
 ...
 *
 * Levels: 0 (0 min), 1 (1-15), 2 (15-30), 3 (30-60), 4 (60+).
 *
