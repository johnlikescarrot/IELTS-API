...
function datasetSummary(): Record<string, number> {
  ...
  return {
    ...
    wordbankRows: wordbanks.rows,
    wordbankWords: wordbanks.distinctWords,
    wordbankBanks: wordbanks.banks,
    wordbankIeltsCambridgeWords: wordbanks.ielts.inCambridge,
  };
}
